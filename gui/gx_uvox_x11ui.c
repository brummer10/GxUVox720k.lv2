...
static LV2UI_Handle instantiate(const struct _LV2UI_Descriptor * descriptor,
	...
	ui->controls[0] = { 0.5, 0.5, 0.0, 1.0, 0.01, 50, 28, 61, 61, false,"GAIN", KNOB, GAIN};
	ui->controls[1] = { 0.5, 0.5, 0.0, 1.0, 0.01, 120, 28, 61, 61, false,"CLIPPING", KNOB, CLIPPING};
	ui->controls[2] = { 0.5, 0.5, 0.0, 1.0, 0.01, 190, 28, 61, 61, false,"BASS", KNOB, BASS};
	ui->controls[3] = { 0.5, 0.5, 0.0, 1.0, 0.01, 260, 28, 61, 61, false,"TREBLE", KNOB, TREBLE};
	ui->controls[4] = { 0.0, 0.0, 0.0, 1.0, 1.0, 340, 28, 61, 61, false,"REVERB", SWITCH, REVERB};
	ui->controls[5] = { 0.5, 0.5, 0.0, 1.0, 0.01, 410, 28, 61, 61, false,"-LEVEL", KNOB, REVERBLEVEL};
	ui->controls[6] = { 0.25, 0.25, 0.0, 1.0, 0.01, 480, 28, 61, 61, false,"VOLUME", KNOB, VOLUME};
