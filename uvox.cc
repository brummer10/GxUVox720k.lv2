...
inline void Dsp::init(uint32_t samplingFreq)
{
	...
	fConst133 = (3.28975314022925e-25 * fConst20);
	fConst134 = (4.63855192772325e-22 - fConst133);
	fConst135 = (5.78996552680348e-27 * fConst20);
	fConst136 = (fConst20 * (fConst135 - 5.84845002707423e-24));
	fConst137 = ((fConst20 * (7.58543968511527e-24 - fConst135)) - 1.46211250676856e-21);
	fConst138 = (1.92998850893449e-25 * fConst20);
	fConst139 = (fConst138 - 4.82497127233624e-23);
	fConst140 = (9.86925942068776e-27 * fConst20);
	fConst141 = ((fConst20 * (2.25750171045065e-23 - fConst140)) - 7.13333677544659e-21);
	fConst142 = (1.04508700533044e-20 + (fConst20 * (fConst140 - 2.55357949307128e-23)));
	fConst143 = (2.19316876015283e-24 * fConst20);
	fConst144 = (fConst30 * (fConst143 - 3.97694601841047e-21));
	fConst145 = ((fConst30 * (4.47040898944486e-21 - fConst143)) - 1.10766098997618e-15);
	fConst146 = ((5.48292190038209e-23 * fConst30) - 3.65528126692139e-17);
	fConst147 = (1.8276406334607e-17 + (fConst20 * (fConst49 - 2.48010833960616e-19)));
	fConst148 = (4.11219142528656e-25 * fConst20);
	fConst149 = ((fConst20 * (2.31927596386162e-22 + fConst148)) - 1.40362800649781e-19);
	fConst150 = (2.41248563616812e-25 * fConst20);
	fConst151 = (0 - (2.41248563616812e-23 + fConst150));
	fConst152 = (1.44749138170087e-26 * fConst20);
	fConst153 = (fConst20 * (7.31056253384278e-24 - fConst152));
	fConst154 = ((fConst20 * (fConst152 - 9.48179960639409e-24)) - 7.31056253384278e-22);
	fConst155 = (2.46731485517194e-26 * fConst20);
	fConst156 = (fConst20 * ((fConst20 * (fConst155 - 2.82187713806331e-23)) - 3.5666683877233e-21));
	fConst157 = ((fConst20 * (5.22543502665222e-21 + (fConst20 * (3.1919743663391e-23 - fConst155)))) - 4.25341820150853e-18);
	fConst158 = (2.74146095019104e-24 * fConst20);
	fConst159 = (fConst20 * (4.05403922331282e-18 + (fConst20 * (0 - (1.98847300920524e-21 + fConst158)))));
	fConst160 = (5.5383049498809e-16 + (fConst20 * ((fConst20 * (2.23520449472243e-21 + fConst158)) - 5.85755500041183e-18)));
	fConst161 = (7.31056253384278e-17 - (1.09658438007642e-22 * fConst30));
	fConst162 = (1.92998850893449e-26 * fConst30);
	fConst163 = (2.92422501353711e-21 - fConst162);
	fConst164 = (3.28975314022925e-26 * fConst30);
	fConst165 = (1.42666735508932e-20 - fConst164);
	fConst166 = (fConst164 - 2.09017401066089e-20);
	fConst167 = (7.95389203682095e-21 * fConst30);
	fConst168 = (2.21532197995236e-15 - (8.94081797888972e-21 * fConst30));
	fConst169 = (1.8276406334607e-17 + (fConst20 * (2.48010833960616e-19 + fConst49)));
	fConst170 = (1.40362800649781e-19 + (fConst20 * (2.31927596386162e-22 - fConst148)));
	fConst171 = (fConst20 * (0 - (7.31056253384278e-24 + fConst152)));
	fConst172 = ((fConst20 * (9.48179960639409e-24 + fConst152)) - 7.31056253384278e-22);
	fConst173 = (fConst150 - 2.41248563616812e-23);
	fConst174 = (fConst20 * ((fConst20 * (2.82187713806331e-23 + fConst155)) - 3.5666683877233e-21));
	fConst175 = (4.25341820150853e-18 + (fConst20 * (5.22543502665222e-21 + (fConst20 * (0 - (3.1919743663391e-23 + fConst155))))));
	fConst176 = (fConst20 * ((fConst20 * (fConst158 - 1.98847300920524e-21)) - 4.05403922331282e-18));
	fConst177 = (5.5383049498809e-16 + (fConst20 * (5.85755500041183e-18 + (fConst20 * (2.23520449472243e-21 - fConst158)))));
	fConst178 = (4.63855192772325e-22 + fConst133);
	fConst179 = (0 - (4.82497127233624e-23 + fConst138));
	fConst180 = (fConst20 * (5.84845002707423e-24 + fConst135));
	fConst181 = ((fConst20 * (0 - (7.58543968511527e-24 + fConst135))) - 1.46211250676856e-21);
	fConst182 = ((fConst20 * (0 - (2.25750171045065e-23 + fConst140))) - 7.13333677544659e-21);
	fConst183 = (1.04508700533044e-20 + (fConst20 * (2.55357949307128e-23 + fConst140)));
	fConst184 = (fConst30 * (0 - (3.97694601841047e-21 + fConst143)));
	fConst185 = ((fConst30 * (4.47040898944486e-21 + fConst143)) - 1.10766098997618e-15);
	fConst186 = ((fConst20 * (0 - (8.26702779868721e-20 + fConst49))) - 1.8276406334607e-17);
	fConst187 = ((fConst20 * (0 - (2.31927596386162e-22 + fConst51))) - 4.67876002165938e-20);
	fConst188 = (2.41248563616812e-23 + fConst53);
	fConst189 = (fConst20 * (0 - (1.46211250676856e-24 + fConst55)));
	fConst190 = (7.31056253384278e-22 + (fConst20 * (1.89635992127882e-24 + fConst55)));
	fConst191 = (fConst20 * (3.5666683877233e-21 + (fConst20 * (5.64375427612663e-24 + fConst58))));
	fConst192 = ((fConst20 * ((fConst20 * (0 - (6.38394873267821e-24 + fConst58))) - 5.22543502665222e-21)) - 1.41780606716951e-18);
	fConst193 = (fConst20 * (1.35134640777094e-18 + (fConst20 * (1.98847300920524e-21 + fConst61))));
	fConst194 = ((fConst20 * ((fConst20 * (0 - (2.23520449472243e-21 + fConst61))) - 1.95251833347061e-18)) - 5.5383049498809e-16);
	fConst195 = (fConst30 / fConst32);
	fConst196 = tan((20461.192952830323 / double(iConst0)));
	fConst197 = (2 * (1 - (1.0 / faustpower<2>(fConst196))));
	fConst198 = (1.0 / fConst196);
	fConst199 = (1 + ((fConst198 - 1.0000000000000004) / fConst196));
	fConst200 = (1.0 / (1 + ((1.0000000000000004 + fConst198) / fConst196)));
	IOTA = 0;
	fConst201 = (1 + fConst198);
	fConst202 = (2.0 / fConst201);
	fConst203 = (0 - ((1 - fConst198) / fConst201));
	fConst204 = (7.10269964334188e-17 * fConst20);
	fConst205 = (0 - (3.31899550200126e-10 + fConst204));
	fConst206 = (2.13080989300256e-16 * fConst20);
	fConst207 = (3.31899550200126e-10 + fConst206);
	fConst208 = (3.31899550200126e-10 - fConst206);
	fConst209 = (fConst204 - 3.31899550200126e-10);
	fConst210 = (fConst30 / fConst26);
	fConst211 = (1256.6370614359173 * fConst10);
	fConst212 = (1 + ((fConst12 - fConst211) / fConst7));
	fConst213 = (1 + ((fConst211 + fConst12) / fConst7));
	fConst214 = (2 * (0 - fConst2));
	clear_state_f();
}
...
#define fslider6 (*fslider6_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec5[0] = ((fConst30 * ((((((((fRec8[0] * (((fRec6[0] * (fConst194 + (fConst193 * fRec6[0]))) + (fConst20 * (fRec7[0] * (((fRec6[0] * (fConst192 + (fConst191 * fRec6[0]))) + (fConst20 * (fRec7[0] * ((fRec6[0] * (fConst190 + (fConst189 * fRec6[0]))) + fConst188)))) + fConst187)))) + fConst186)) + (fRec8[1] * (fConst146 + ((fRec6[0] * (fConst185 + (fConst184 * fRec6[0]))) + (fConst30 * (fRec7[0] * (((fRec6[0] * (fConst183 + (fConst182 * fRec6[0]))) + (fRec7[0] * ((fRec6[0] * (fConst181 + (fConst180 * fRec6[0]))) + fConst179))) + fConst178))))))) + (fRec8[2] * (((fRec6[0] * (fConst177 + (fConst176 * fRec6[0]))) + (fConst20 * (fRec7[0] * (((fRec6[0] * (fConst175 + (fConst174 * fRec6[0]))) + (fConst20 * (fRec7[0] * (fConst173 + (fRec6[0] * (fConst172 + (fConst171 * fRec6[0]))))))) + fConst170)))) + fConst169))) + (fRec8[3] * (((fRec6[0] * (fConst168 + (fConst167 * fRec6[0]))) + (fConst30 * (fRec7[0] * (((fRec6[0] * (fConst166 + (fConst165 * fRec6[0]))) + (fRec7[0] * (9.64994254467247e-23 + (fRec6[0] * (fConst163 + (fConst162 * fRec6[0])))))) - 9.27710385544649e-22)))) + fConst161))) + (fRec8[4] * (((fRec6[0] * (fConst160 + (fConst159 * fRec6[0]))) + (fConst20 * (fRec7[0] * (((fRec6[0] * (fConst157 + (fConst156 * fRec6[0]))) + (fConst20 * (fRec7[0] * ((fRec6[0] * (fConst154 + (fConst153 * fRec6[0]))) + fConst151)))) + fConst149)))) + fConst147))) + (fRec8[5] * (fConst146 + ((fRec6[0] * (fConst145 + (fConst144 * fRec6[0]))) + (fConst30 * (fRec7[0] * (((fRec6[0] * (fConst142 + (fConst141 * fRec6[0]))) + (fRec7[0] * (fConst139 + (fRec6[0] * (fConst137 + (fConst136 * fRec6[0])))))) + fConst134))))))) + (fRec8[6] * (((fRec6[0] * (fConst63 + (fConst62 * fRec6[0]))) + (fConst20 * (fRec7[0] * (((fRec6[0] * (fConst60 + (fConst59 * fRec6[0]))) + (fConst20 * (fRec7[0] * ((fRec6[0] * (fConst57 + (fConst56 * fRec6[0]))) + fConst54)))) + fConst52)))) + fConst50))) / fTemp2)) - (fConst33 * ((fConst31 * fRec5[1]) + (fConst29 * fRec5[2]))));
		double fTemp3 = (((fRec5[0] * fTemp1) + (7.53431799414604e-09 * (fRec4[0] * fRec5[1]))) + (fRec5[2] * fTemp1));
		double fTemp4 = ((fSlow4 * fTemp3) + (fSlow3 * symclip((fConst195 * fTemp3))));
		double fTemp5 = ((0.7 * fRec17[1]) + (fSlow5 * fTemp4));
		fVec0[IOTA&511] = fTemp5;
		fRec17[0] = fVec0[(IOTA-346)&511];
		double 	fRec18 = (0 - (0.7 * fVec0[IOTA&511]));
		double fTemp6 = (fRec17[1] + (fRec18 + (0.7 * fRec15[1])));
		fVec1[IOTA&127] = fTemp6;
		fRec15[0] = fVec1[(IOTA-112)&127];
		double 	fRec16 = (0 - (0.7 * fVec1[IOTA&127]));
		double fTemp7 = (fRec15[1] + (fRec16 + (0.7 * fRec13[1])));
		fVec2[IOTA&63] = fTemp7;
		fRec13[0] = fVec2[(IOTA-36)&63];
		double 	fRec14 = (0 - (0.7 * fVec2[IOTA&63]));
		double fTemp8 = (fRec14 + fRec13[1]);
		double fTemp9 = (fTemp8 + (0.733 * fRec11[1]));
		fVec3[IOTA&4095] = fTemp9;
		fRec11[0] = fVec3[(IOTA-2250)&4095];
		fRec12[0] = fVec3[IOTA&4095];
		double fTemp10 = (fTemp8 + (0.753 * fRec19[1]));
		fVec4[IOTA&4095] = fTemp10;
		fRec19[0] = fVec4[(IOTA-2052)&4095];
		fRec20[0] = fVec4[IOTA&4095];
		double fTemp11 = (fTemp8 + (0.773 * fRec21[1]));
		fVec5[IOTA&2047] = fTemp11;
		fRec21[0] = fVec5[(IOTA-1866)&2047];
		fRec22[0] = fVec5[IOTA&2047];
		double fTemp12 = (fRec13[1] + (fRec14 + (0.802 * fRec23[1])));
		fVec6[IOTA&2047] = fTemp12;
		fRec23[0] = fVec6[(IOTA-1600)&2047];
		fRec24[0] = fVec6[IOTA&2047];
		double fTemp13 = (((fRec24[1] + fRec22[1]) + fRec20[1]) + fRec12[1]);
		double fTemp14 = (fTemp13 + fTemp13);
		fVec7[0] = fTemp14;
		fRec10[0] = ((fConst203 * fRec10[1]) + (fConst202 * (fVec7[0] + fVec7[1])));
		fRec9[0] = (fRec10[0] - (fConst200 * ((fConst199 * fRec9[2]) + (fConst197 * fRec9[1]))));
		fRec3[0] = (((iSlow6==0)? fTemp4 : ((iSlow6==1)?(fTemp4 + (fConst200 * (fRec9[2] + (fRec9[0] + (2 * fRec9[1]))))):fTemp4) ) - (fConst27 * (((fConst25 * fRec3[1]) + (fConst24 * fRec3[2])) + (fConst22 * fRec3[3]))));
		fRec25[0] = ((0.993 * fRec25[1]) + fSlow7);
		fRec2[0] = ((fConst210 * (fRec25[0] * ((((fConst209 * fRec3[0]) + (fConst208 * fRec3[1])) + (fConst207 * fRec3[2])) + (fConst205 * fRec3[3])))) - (fConst19 * ((fConst18 * fRec2[2]) + (fConst16 * fRec2[1]))));
		fRec1[0] = ((fConst19 * (fRec2[2] + (fRec2[0] + (2 * fRec2[1])))) - (fConst14 * ((fConst13 * fRec1[2]) + fTemp0)));
		fRec0[0] = ((fConst14 * ((fTemp0 + (fConst213 * fRec1[0])) + (fConst212 * fRec1[2]))) - (fConst6 * ((fConst5 * fRec0[2]) + (fConst3 * fRec0[1]))));
		output0[i] = (FAUSTFLOAT)(fConst6 * (((fConst2 * fRec0[0]) + (fConst214 * fRec0[1])) + (fConst2 * fRec0[2])));
		// post processing
