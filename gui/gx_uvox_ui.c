...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    const char* plug_name = "GxUVox720k" ;
    ...
    set_expose_func(GX_VOXK_PAINT_BOX(ui->pbox),"pedal_expose");
    ...
    ui->label[1] = gtk_label_new("CLIPPING");
    ...
    ui->args[1]->ui = ui;
    ui->args[1]->port_index = (int)CLIPPING;
    ...
    ui->adj[5] = gtk_adjustment_new( 0.5, 0.0, 1.0, 0.01, 0.01*10.0, 0);
    ui->knob[5] = gtk_knob_new_with_adjustment(GTK_ADJUSTMENT(ui->adj[5]));
    ui->label[5] = gtk_label_new("TREBLE");
    ...
    ui->args[5]->ui = ui;
    ui->args[5]->port_index = (int)TREBLE;
    g_signal_connect(G_OBJECT(ui->adj[5]), "value-changed",
          G_CALLBACK(ref_value_changed),(gpointer*)ui->args[5]);

    ui->adj[4] = gtk_adjustment_new( 0.0, 0.0, 1.0, 1.0, 1.0*10.0, 0);
    ui->knob[4] = gtk_switch_new_with_adjustment(GTK_ADJUSTMENT(ui->adj[4]));
    ui->label[4] = gtk_label_new("REVERB");
    ...
    ui->args[4]->ui = ui;
    ui->args[4]->port_index = (int)REVERB;
    ...
    ui->label[3] = gtk_label_new("-LEVEL");
    ...
    ui->args[6]->ui = ui;
    ui->args[6]->port_index = (int)VOLUME;
